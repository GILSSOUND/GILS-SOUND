...
const translations = {
    ko: {
        ...
        "plan_single_price": "990원",
        "plan_single_desc1": "1곡 생성",
        "plan_single_desc2": "가사 자동 생성 AI",
        "plan_starter_title": "스타터 패키지 (단건)",
        "plan_starter_price": "5,990원",
        "plan_starter_desc1": "10곡 생성 (장기보관)",
        "plan_pro_badge": "월플랜 (한달이용권)",
        "plan_pro_title": "프로 크리에이터 팩",
        "plan_pro_price": "19,900원 <span style='font-size: 14px; color: #9CA3AF; font-weight: normal;'>/ 월</span>",
        "plan_pro_desc1": "매월 100크레딧 (약 33곡)",
        "plan_pro_desc2": "우선 생성 대기열 적용",
    ...
    en: {
        ...
        "plan_single_price": "₩990",
        "plan_single_desc1": "Generate 1 song",
        "plan_single_desc2": "Auto Lyrics AI",
        "plan_starter_title": "Starter Package",
        "plan_starter_price": "₩5,990",
        "plan_starter_desc1": "Generate 10 songs",
        "plan_pro_badge": "Monthly Plan",
        "plan_pro_title": "Pro Creator Pack",
        "plan_pro_price": "₩19,900 <span style='font-size: 14px; color: #9CA3AF; font-weight: normal;'>/ month</span>",
        "plan_pro_desc1": "100 credits/mo (~33 songs)",
        "plan_pro_desc2": "Priority generation queue",
    ...
    ja: {
        ...
        "plan_single_price": "990ウォン",
        "plan_single_desc1": "1曲作成",
        "plan_single_desc2": "自動作詞AI",
        "plan_starter_title": "スターターパッケージ",
        "plan_starter_price": "5,990ウォン",
        "plan_starter_desc1": "10曲作成（長期保管）",
        "plan_pro_badge": "月額プラン",
        "plan_pro_title": "プロクリエイターパック",
        "plan_pro_price": "19,900ウォン <span style='font-size: 14px; color: #9CA3AF; font-weight: normal;'>/ 月</span>",
        "plan_pro_desc1": "毎月100クレジット (約33曲)",
        "plan_pro_desc2": "優先作成キュー適用",
    ...
    zh: {
        ...
        "plan_single_price": "990韩元",
        "plan_single_desc1": "生成 1 首歌曲",
        "plan_single_desc2": "自动作词 AI",
        "plan_starter_title": "初学者套餐",
        "plan_starter_price": "5,990韩元",
        "plan_starter_desc1": "生成 10 首歌曲",
        "plan_pro_badge": "包月套餐",
        "plan_pro_title": "专业创作者包",
        "plan_pro_price": "19,900韩元 <span style='font-size: 14px; color: #9CA3AF; font-weight: normal;'>/ 月</span>",
        "plan_pro_desc1": "每月 100 积分（约 33 首）",
        "plan_pro_desc2": "优先生成队列",
